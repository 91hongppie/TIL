...
function sleepAndError(g, n) {
    setTimeout(function()  {
        ...
        // g의 throw 메서드에 예외를 던진다.
        /* 
            제너레이터 객체 g의 throw 메서드는 호출된 그 자리에서 예외를 던지는 것이 아니라
            제너레이터를 한 번 동작시킨 다음에 yield 문이 위치한 자리에서 예외를 던집니다.
            그러면 이 예외는 제너레이터가 던진 예외가 되므로 catch 블록 안에서 잡아낼 수 있습니다.
        */
