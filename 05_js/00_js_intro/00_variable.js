...
if (MY_FAV === 7) {
    ...
    // 여기서도 const 는 재선언이 불가능하기 때문에 let 으로 설정.
    let MY_FAV = 20
...
if (a === 1) {
    ...
    console.log(a) // 11 밖의 a와 같다.
    console.log(b) // 22 밖의 b와 다르다.
}
...
// 이 표현은 변수와 변수의 속성이 변하지 않는다는 것을 프로그래머에게 알려준다ㅏ.
const API_KET = 'alsdflnsdnf'